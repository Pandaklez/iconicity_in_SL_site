navbarPage("Iconicity patterns in Sign Languges",
           tabPanel("About",
                    column(1,""),
                    fluidPage(column(7, HTML("<p><strong><span style=\"font-size: 14.0pt; font-family: 'Verdana','sans-serif';\">About us</span></strong></p>
<p style=\"text-align: justify;\"><span style=\"font-size: 14.0pt; font-family: 'Verdana','sans-serif';\">This is a linguistic resource, which deals with nouns from different sign languages in respect to their iconicity type. It is based on a current research about iconicity patterns in non-abstract nouns from 7 semantic fields according to 19 languages. You can download our database with annotated signs on this website.</span></p>
                                   <p style=\"text-align: justify;\"><span style=\"font-size: 14.0pt; font-family: 'Verdana','sans-serif';\">Here you can find data on 1542 annotated signs in formats: maps and graphs. There is an opportunity to search maps of words and look up for signs' characteristics in respect to semantic fields. On the graphs' page you can find some statistics on our data.</span></p>
                                   <p style=\"text-align: justify;\"><span style=\"font-size: 14.0pt; font-family: 'Verdana','sans-serif';\">You can read more about methodology of our research here [LINK]</span></p>
